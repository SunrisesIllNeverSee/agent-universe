...
const seatLabel = (id, transferCount) =>
  `D${toRoman(id)}${transferCount > 0 ? toSup(transferCount) : ""}`;
...
// Market prices shown on public registry
// Early access (matched via COMMAND) noted on detail view
const INITIAL_SEATS = [
  { id:1,  wave:"1a", tier:"Internal", basePrice:95000,  earlyPrice:65000,  owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:2,  wave:"1a", tier:"Internal", basePrice:95000,  earlyPrice:65000,  owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:3,  wave:"1a", tier:"Internal", basePrice:95000,  earlyPrice:65000,  owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:4,  wave:"1a", tier:"Internal", basePrice:95000,  earlyPrice:65000,  owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:5,  wave:"1a", tier:"Internal", basePrice:95000,  earlyPrice:65000,  owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:6,  wave:"1b", tier:"Embedded", basePrice:180000, earlyPrice:130000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:7,  wave:"1b", tier:"Embedded", basePrice:180000, earlyPrice:130000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:8,  wave:"1b", tier:"Embedded", basePrice:180000, earlyPrice:130000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:9,  wave:"2a", tier:"Internal", basePrice:275000, earlyPrice:195000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:10, wave:"2a", tier:"Internal", basePrice:275000, earlyPrice:195000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:11, wave:"2a", tier:"Internal", basePrice:275000, earlyPrice:195000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:12, wave:"2a", tier:"Internal", basePrice:275000, earlyPrice:195000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:13, wave:"2a", tier:"Internal", basePrice:275000, earlyPrice:195000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:14, wave:"2b", tier:"Embedded", basePrice:370000, earlyPrice:260000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:15, wave:"2b", tier:"Embedded", basePrice:370000, earlyPrice:260000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:16, wave:"2b", tier:"Embedded", basePrice:370000, earlyPrice:260000, owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
  { id:17, wave:"3",  tier:"Bid",      basePrice:null,   earlyPrice:null,   owner:null, ownerEntity:null, status:"LOCKED", signal:null, lastSalePrice:null, lastSaleDate:null, transferCount:0 },
];

const CASCADE_GATES = [
  { trigger:[1,2,3,4,5],     unlocks:[6,7,8],           label:"DW1a → DW1b" },
  { trigger:[6,7,8],         unlocks:[9,10,11,12,13],   label:"DW1b → DW2a" },
  { trigger:[9,10,11,12,13], unlocks:[14,15,16],         label:"DW2a → DW2b" },
  { trigger:[14,15,16],      unlocks:[17],               label:"DW2b → DW3"  },
];

const WAVES = [
  { key:"1a", label:"DW1a", name:"Wave 1a", sub:"Internal", step:5, accent:"#1a6b4a", earlyStep:"CW1a" },
  { key:"1b", label:"DW1b", name:"Wave 1b", sub:"Embedded", step:6, accent:"#1a5a6b", earlyStep:"CW1b" },
  { key:"2a", label:"DW2a", name:"Wave 2a", sub:"Internal", step:7, accent:"#6b5a1a", earlyStep:"CW2a" },
  { key:"2b", label:"DW2b", name:"Wave 2b", sub:"Embedded", step:8, accent:"#6b2a1a", earlyStep:"CW2b" },
  { key:"3",  label:"DW3",  name:"Wave 3",  sub:"Bid",      step:null, accent:"#4a2a6b", earlyStep:"CW3" },
];
...
export default function DeploySeatRegistry() {
  ...
  const c = {
    ...
    deploy:"#5a1a6b", deployBg:"#f2e8f5",
  };

  const tierColor = (tier) => tier === "Internal" ? c.green : tier === "Embedded" ? c.blue : c.deploy;
  const tierBg = (tier) => tier === "Internal" ? c.greenBg : tier === "Embedded" ? c.blueBg : c.deployBg;
  ...
  const base = {
    ...
    earlyNote:{ fontSize:"9px", fontFamily:mono, color:c.amber, marginTop:"2px", letterSpacing:"0.5px" },
    ...
    earlyBox:{ margin:"16px 0", padding:"14px 16px", background:c.amberBg, border:`1px solid #e8d090`, borderRadius:"4px", fontSize:"12px", lineHeight:"1.7" },
    ...
    termsBox:{ margin:"20px 0", padding:"16px 18px", background:c.deployBg, border:`1px solid #d8bce5`, borderRadius:"4px", fontSize:"12px", lineHeight:"1.7" },
            ...
            <div style={base.boardGrid}>
              {wSeats.map(seat => (
                ...
                >
                  ...
                  {seat.earlyPrice && seat.status !== "TAKEN" && (
                    <div style={base.earlyNote}>via {w.earlyStep}: {fmtShort(seat.earlyPrice)}</div>
                  )}
  ...
  const renderDetail = () => {
    ...
    return (
      <div style={{...base.content, ...base.detail}}>
        ...
        {w.step && <div style={base.row}><span style={base.rowLabel}>Step</span><span style={base.rowVal}>{w.step} of 8</span></div>}
        ...
        {selected.id !== 17 && <div style={base.row}><span style={base.rowLabel}>Market Price</span><span style={{...base.rowVal, color:tierColor(selected.tier)}}>{fmt(selected.basePrice)}</span></div>}
        ...
        {selected.earlyPrice && selected.status !== "TAKEN" && (
          <div style={base.earlyBox}>
            <div style={{fontSize:"10px", fontFamily:mono, letterSpacing:"1px", color:c.amber, marginBottom:"6px", fontWeight:600}}>EARLY ACCESS — COMMAND LICENSEES</div>
            <div style={{color:c.textSec}}>Available at <strong style={{color:c.text}}>{fmt(selected.earlyPrice)}</strong> for active {w.earlyStep} COMMAND licensees — matched pricing. Market rate applies once {w.earlyStep} closes.</div>
          </div>
        )}

        {selected.id === 17 && selected.status === "AVAILABLE" && (
          <div style={base.termsBox}>
            <div style={{fontSize:"10px", fontFamily:mono, letterSpacing:"1px", color:c.deploy, marginBottom:"10px", fontWeight:600}}>DXVII — BID TERMS</div>
    ...
    return (
      <div style={base.content}>
        <div style={{display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"20px"}}>
          <div style={{fontSize:"11px", fontFamily:mono, letterSpacing:"1.5px", color:c.textSec, textTransform:"uppercase"}}>Admin — DEPLOY Seat Registry</div>
              ...
              <div key={seat.id}>
                <div style={base.adminRow(seat.status==="LOCKED")}>
                  <div style={{display:"flex", alignItems:"center", gap:"12px"}}>
                    <span style={{fontFamily:mono, fontWeight:600, minWidth:"64px"}}>{label}</span>
        ...
        <button style={{...base.adminBtn(), padding:"10px 20px", marginTop:"16px"}} onClick={() => {
          ...
          a.download = `deploy-registry-${new Date().toISOString().split("T")[0]}.json`;
  ...
  const renderExplainer = () => (
    <div style={base.overlay} onClick={() => setShowExplainer(false)}>
      <div style={base.modal} onClick={e => e.stopPropagation()}>
        <div style={base.modalTitle}>How the DEPLOY Seat Registry Works</div>
        <div style={{marginBottom:"20px"}}><div style={{fontWeight:600, marginBottom:"6px"}}>What is this?</div><p style={{color:c.textSec, margin:"0 0 8px", lineHeight:"1.7"}}>The DEPLOY Seat Registry tracks 17 licensed positions for DEPLOY · by MO§ES™. Each seat represents a permanent, transferable license. No additional seats will be created.</p></div>
        <div style={{marginBottom:"20px"}}><div style={{fontWeight:600, marginBottom:"6px"}}>Seat IDs</div><p style={{color:c.textSec, margin:"0", lineHeight:"1.7"}}>Each seat carries a Roman numeral ID prefixed with D — DI through DXVII. Transfer history is shown as a superscript: DI¹ has transferred once, DI² twice.</p></div>
        <div style={{marginBottom:"20px"}}><div style={{fontWeight:600, marginBottom:"6px"}}>Steps & Waves</div><p style={{color:c.textSec, margin:"0 0 8px", lineHeight:"1.7"}}>DEPLOY wave steps run 5–8 in the joint COMMAND/DEPLOY sequence. Each step unlocks in parallel with its corresponding COMMAND wave.</p><div style={{fontFamily:mono, fontSize:"11px", color:c.textSec, lineHeight:"2", padding:"8px 0"}}><div><span style={{color:c.green}}>Step 5 — DW1a</span> · 5 Internal seats · $95,000 market</div><div><span style={{color:c.blue}}>Step 6 — DW1b</span> · 3 Embedded seats · $180,000 market</div><div><span style={{color:c.amber}}>Step 7 — DW2a</span> · 5 Internal seats · $275,000 market</div><div><span style={{color:c.red}}>Step 8 — DW2b</span> · 3 Embedded seats · $370,000 market</div><div><span style={{color:c.deploy}}>DW3</span> · 1 Bid seat · open bid</div></div></div>
        <div style={{marginBottom:"20px"}}><div style={{fontWeight:600, marginBottom:"6px"}}>Early Access</div><p style={{color:c.textSec, margin:"0", lineHeight:"1.7"}}>Active COMMAND licensees at each wave step receive early access to the corresponding DEPLOY seats at matched pricing. Market pricing activates when the COMMAND wave closes.</p></div>
        <div style={{marginBottom:"20px"}}><div style={{fontWeight:600, marginBottom:"6px"}}>Seat Transfers</div><p style={{color:c.textSec, margin:"0", lineHeight:"1.7"}}>Seats are transferable between parties and between products (COMMAND ↔ DEPLOY). All transfers confirmed by Ello Cello LLC. Each transfer increments the seat's superscript.</p></div>
  ...
  return (
    <div style={base.app}>
      <div style={base.header}>
        <div>
          <div style={base.logo}>Deploy</div>
          <div style={base.logosub}>Seat Registry · by MO§ES™</div>
        </div>
        <div style={base.nav}>
      ...
      <div style={base.stats}>
        ...
        <span><span style={base.statLabel}>Active Wave</span><span style={{...base.statVal, color:WAVES.find(w=>w.key===activeWave)?.accent}}>DW{activeWave.toUpperCase()}</span></span>
      </div>
      ...
      <div style={base.footer}>DEPLOY · by MO§ES™ · © 2026 Ello Cello LLC · All Rights Reserved</div>
    </div>
  );
}
